                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="trending" class="form-select" id="trending">
                                <option value="0" @selected(old('trending') == 0)>No</option>
                                <option value="1" @selected(old('trending') == 1)>Yes</option>
                            </select>
                            @error('trending')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="regular_price" id="regular_price" class="form-control"
                                pattern="\d+(\.\d{2})?" title="Please enter a valid price (e.g., 20.30 or 20)"
                                value="{{ old('regular_price') }}" placeholder="2 or 20 or 20.20">
                            @error('regular_price')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="sale_price" id="sale_price" class="form-control"
                                ...
                                value="{{ old('sale_price') }}" placeholder="2 or 20 or 20.20">
                            @error('sale_price')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
