...
@section('content')
    <div class="shadow table-container py-3 px-4 mb-5 bg-white" style="border: 2px solid #ccc;">
        <form action="{{ route('ecommerce.admin.users.store') }}" method="post">
            @csrf
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    value="{{ old('phone') }}" title="Please enter a valid phone (+95)">
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select name="role_as" class="form-select" id="role_as">
                        <option value="0" @selected(old('role_as') == 0)>User</option>
                        <option value="1" @selected(old('role_as') == 1)>Admin</option>
                    </select>
                    @error('role_as')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
