...
@section('button')
    <div class="ms-auto">
        <a href="{{ route('ecommerce.admin.brands.create') }}" class="btn btn-primary">Add Brand</a>
    </div>
@endsection
        ...
        <tbody>
            ...
            @foreach ($brands as $brand)
                <tr>
                    ...
                    <td>
                        <a href="{{ url("ecommerce/admin/brands/$brand->id/edit") }}" class="btn btn-info mb-1">Edit</a><br>
                        <a href="{{ url("ecommerce/admin/brands/$brand->id") }}" class="btn btn-secondary mb-1">Details</a><br>
                        <button class="btn btn-danger delete-button" data-id="{{ $brand->id }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    Are you sure to delete this brand {{ $brand->name }}?<br>
                                    <strong>If you delete this, every product and variant of this brand will also be deleted!</strong>
                                </div>
