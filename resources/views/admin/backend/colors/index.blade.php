...
@section('page-title', 'Colors List')

@section('button')
    <div class="ms-auto">
        <a href="{{ route('ecommerce.admin.colors.create') }}" class="btn btn-primary">Add Color</a>
    </div>
@endsection
        ...
        <tbody>
            ...
            @foreach ($colors as $color)
                <tr>
                    ...
                    <td>
                        <a href="{{ url("ecommerce/admin/colors/$color->id/edit") }}" class="btn btn-info">Edit</a>
                        <a href="{{ url("ecommerce/admin/colors/$color->id") }}" class="btn btn-secondary mt-1">Details</a>
                        <button class="btn btn-danger delete-button mt-1" data-id="{{ $color->id }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    Are you sure to delete this color {{ $color->name }}?<br>
                                    <strong>If you delete this, every variant which has this color will also be deleted!</strong>
                                </div>
